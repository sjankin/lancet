...
total_speeches_who <- inner_join(ungc_files, regions, by = c("Country" = "Country or Area")) %>% 
...
#merging WHO designations with mention counts
regional_data <- inner_join(total_counts, regions, by = c("country" = "Country or Area"))
...
ggplot(proportions_hces_who, aes(x=Year)) +
  ...
  annotate("text", x = 2013, y = 1.5, label = "Europe", colour = "darkgreen") +
  #annotate("text", x = 2012, y = 10, label = "Latin Am. & Carribean", colour = "red")+
  annotate("text", x = 2013, y = 4, label = "North America", colour = "purple")+
  annotate("text", x = 2013, y = 1.5, label = "South-East Asia", colour = "brown") +
  annotate("text", x = 2013, y = 1.5, label = "Western Pacific", colour = "pink") 
