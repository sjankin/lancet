...
- affiliation: The Lancet, University College London
  email: n.watts@ucl.ac.uk
  name: Nick Watts
date: 29 March 2019
output:
  html_notebook:
...
corp_summary <- summarise(group_by(summary(ungd_corpus, n = 8093),Year),
...
map <- joinCountryData2Map(subset(total_counts, year==2018 & health_count>0), joinCode="ISO3", nameJoinColumn="country")
...
mapParams <- mapCountryData(new_world, nameColumnToPlot="health_count", 
                            mapTitle="2018 UN General Debate: Health", 
...
map <- joinCountryData2Map(subset(total_counts, year==2018 & climate_count>0), joinCode="ISO3", nameJoinColumn="country")
...
mapParams <- mapCountryData(new_world, nameColumnToPlot="climate_count", 
                            mapTitle="2018 UN General Debate: Climate Change", 
                            catMethod = "categorical", 
                            colourPalette = "heat", 
                            oceanCol = "lightblue", 
                            missingCountryCol = "white", 
...
map <- joinCountryData2Map(subset(total_counts, year==2018 & intersection_count>0), joinCode="ISO3", nameJoinColumn="country")
...
mapParams <- mapCountryData(new_world, nameColumnToPlot="intersection_count", 
                            mapTitle="2018 UN General Debate: Intersection", 
                            catMethod = "categorical", 
                            colourPalette = "heat", 
                            oceanCol = "lightblue", 
                            missingCountryCol = "white", 
